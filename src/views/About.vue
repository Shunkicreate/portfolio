          ...
          <div class="row">
            <div class="col-md-4">
              <div class="row justify-content-center content-title">
                <div class="col-12"><h3>Games</h3></div>
              </div>
            ...
            <div class="col-md-8 border-start border-secondary border-1 text-start">
              <ul class="lists">
                ...
                <li class="list-items">Winning Eleven</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div class="row text-center justify-content-center history_row">
        <div class="col-md-8 col-11 border border-secondary border-2 rounded-3">
          <div class="row">
            <div class="col-md-4">
              <div class="row justify-content-center content-title">
                <div class="col-12"><h3>Music</h3></div>
              </div>
              <div class="row justify-content-center">
                <div class="col-lg-4 col-md-8 col-6">
                  <svg
            ...
            <div class="col-md-8 border-start border-secondary border-1 text-start">
              <ul class="lists">
                ...
                <li class="list-items">Radwimps</li>
              </ul>
            </div>
          </div>
        </div>
          ...
          <div class="row">
            ...
            <div class="col-md-8 border-start border-secondary border-1 text-start">
              <ul class="lists">
                ...
                <li class="list-items">蜜蜂と遠雷  奥田陸</li>
              </ul>
            </div>
          </div>
        </div>
